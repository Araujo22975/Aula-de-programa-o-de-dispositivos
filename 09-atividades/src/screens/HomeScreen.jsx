        ...
        listaReceitas.map(
          receita => {
           ...
           <Card style={{margin:'50'}}>
            <Card.Content>
              <Title style={{fontWeight:'bold', color:'black'}}>{receita.nome}</Title>
              <Card.Cover style={{width:'100%' , height: 300}} source={{ uri: receita.imagem}} />
              
              <Button
              
              mode='contained'
              onPress={() => navigation.navigate('FeedScreen', {receita})}
            >
